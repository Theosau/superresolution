...
class ConvUNetTwoModels(nn.Module):
    def __init__(self, input_size, channels_init=16, final_out_channels=20):
        super(ConvUNetTwoModels, self).__init__()
        self.input_size = input_size
        self.channels_init = channels_init
        ...
        self.dec4 = nn.Sequential(
          nn.Conv2d(in_channels=3, out_channels=final_out_channels, kernel_size=3, stride=1, padding=1),
          nn.ReLU(),
        )
...
class SmallLinear(nn.Module):
    def __init__(self, input_features):
        ...
        self.lin1 = nn.Linear(input_features, 15)
