...
class ConvNet(nn.Module):
    def __init__(self, input_size, channels_in=1, channels_init=3, channels_out=1, latent_space_size=20):
        ...
        self.enc1 = nn.Sequential(
            ...
            # nn.LayerNorm([channels_init, 64, 64, 64]),
            nn.ReLU(),
        )
        ...
        self.enc2 = nn.Sequential(
            ...
            # nn.LayerNorm([channels_init*2, 32, 32, 32]),
            nn.ReLU(),
        )
        ...
        self.enc3 = nn.Sequential(
            ...
            # nn.LayerNorm([channels_init*4, 8, 8, 8]),
            nn.ReLU(),
        )
        ...
        self.dec00 = nn.Sequential(
            ...
            # nn.BatchNorm3d(channels_init*32),
            # nn.LayerNorm([channels_init*2, 8, 8, 8]),
            nn.ReLU(),
        )
        ...
        self.dec2 = nn.Sequential(
            ...
            # nn.BatchNorm3d(channels_init*4),
            # nn.LayerNorm([channels_init, 16, 16, 16]),
            nn.ReLU(),
        )
