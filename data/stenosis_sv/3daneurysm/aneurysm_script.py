...
if __name__ == "__main__":
    ...
    parser.add_argument("--obs", type=float, help="Increase fraction, ranging 0--1.")
    ...
    parser.add_argument("--refinement", type=float, help="Edge size refinement over aneurysm region.")
    ...
    z0 = 10 # maximum aneurysm position
    zb, ze = 2, 18
    L = ze - zb # aneurysm length
    ...
    # Export the solid to a polydata object written to /model/aneurysm_model.vtp.
    os.mkdir(exmpl_name)
    os.chdir(exmpl_name)
    os.mkdir("model")
    capped_model.write(file_name=os.getcwd() + "/model/aneurysm_model", format="vtp")
    ...
    # mesh refinment over the aneurysm region
