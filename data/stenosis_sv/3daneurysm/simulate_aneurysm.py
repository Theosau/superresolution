...
if __name__ == "__main__":
    ...
    # Run the set-up 
    command = "/usr/local/bin/simvascular --python -- aneurysm_script.py \
        --name {name} \
        --obs {obs} \
        --R {R} \
        --inflow {inflow} \
    ...
    # Run the simulation
    command = "/usr/local/bin/simvascular --python -- aneurysm_solver.py \
        --name {name} \
        --tss {tss} \
        --nt {nt}".format(
            name = name,
    ...
    # Run the post solver
    command = "/usr/local/bin/simvascular --python -- aneurysm_postsolver.py \
        --name {name} \
        --nt {nt}".format(
            name = name,
            nt = nt,
